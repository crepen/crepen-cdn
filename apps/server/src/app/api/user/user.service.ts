...
export class CrepenUserService {
    ...
    getUserByIdOrEmail = async (userIdOrEmail: string, options?: RepositoryOptions) => {
        return this.userRepo.getUserIncludeRoles([
            {
    ...
    getUserDataIncludeRoles = async(userUid: string) => {
        return this.userRepo.getUserIncludeRoles({
            uid : userUid
        })
    }
