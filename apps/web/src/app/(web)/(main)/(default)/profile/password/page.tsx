...
import { ProfilePasswordPageLayout } from '@web/components-v2/page/profile/password/layout/ProfilePasswordPageLayout';
...
const CloudProfilePasswordRoutePage = async (prop: CloudProfileCategoryRoutePageProp) => {
...
export default CloudProfilePasswordRoutePage;